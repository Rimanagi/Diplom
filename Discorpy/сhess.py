...
# Initial parameters
file_path = "/Users/rimanagi/PycharmProjects/Diplom/lense_2/chess/17update copy.jpg"
output_base = "/Users/rimanagi/PycharmProjects/Diplom/Outputbase"
num_coef = 2  # Number of polynomial coefficients
...
slope_hor, dist_hor = lprep.calc_slope_distance_hor_lines(mat1, radius=235, sensitive=0.5)
slope_ver, dist_ver = lprep.calc_slope_distance_ver_lines(mat1, radius=235, sensitive=0.5)
...
# img_corrected = img_corrected[:,:,:3]
print(img_corrected.shape)
io.save_image(output_base + "/corrected_image_color.png", img_corrected)

# Load a test image and correct it.
img = io.load_image("/Users/rimanagi/PycharmProjects/Diplom/lense_2/chess/17cm copy.jpg", average=False)
img_corrected = np.copy(img)
for i in range(img.shape[-1]):
    img_corrected[:, :, i] = post.unwarp_image_backward(img[:, :, i], xcenter,
                                                        ycenter, list_fact)
...
# img_corrected = img_corrected[:, :, :3]
io.save_image(output_base + "/test_image_corrected.png", img_corrected)
