...
# Initial parameters
file_path = "/lense_1/line_pattern/19cm_zoom.jpg"
output_base = "/Users/rimanagi/PycharmProjects/Diplom/OutputBase_LINE"
...
io.save_image(output_base + "/difference.jpg", mat0 - corrected_mat)
print("!!! Done !!!!")
